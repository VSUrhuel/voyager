                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MultiSelectChips(
                        ...
                        label: "Select Days",
                        initialSelection:
                            MentorController.instance.selectedDays,
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            top: screenHeight * 0.015, bottom: 10),
                        child: Text(
                          'Language and Skills',
                          style: TextStyle(
                            fontSize: screenWidth * 0.05,
                      ...
                      MultiSelectChips(
                        ...
                        label: 'Skills',
                        initialSelection:
                            MentorController.instance.selectedSkills,
                        onSelectionChanged: (selected) {
                          MentorController.instance
                              .updateSelectedSkills(selected);
                        },
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                            top: screenHeight * 0.015, bottom: 2),
                        child: Text(
                          'Social Media Links',
                          style: TextStyle(
                            fontSize: screenWidth * 0.05,
                        ...
                        child: Row(
                          children: [
                            FaIcon(
                              ...
                              size: screenWidth *
                                  0.13, // Adjust the size as needed
                            ),
                            SizedBox(
                                width:
                        ...
                        onPressed: () async {
                          ...
                          if (controller.mentorFbUrl.text.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content:
                                    Text('Please enter your Facebook link.'),
                              ),
                            );
                            return;
                          }
                          ...
                          final uri2 =
                              Uri.tryParse(controller.mentorGitUrl.text);
                          if (uri2 == null ||
                              !uri2.hasScheme ||
