...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
          ...
          <img src="https://github.com/user-attachments/assets/f2d69088-86fa-4abf-b499-5a0da6446df2" alt="Alt Text" width="200">
...
<table border="1">
    ...
    <tr>
        <th>Goal</th>
        <td>Allow users to search for available mentors efficiently.</td>
    </tr>
    <tr>
        <th>Preconditions</th>
        <td>User must have a registered account and be on the mentor search page.</td>
    </tr>
    <tr>
        <th>Main Scenario</th>
        <td>
            1. User navigates to the "Mentors" page.<br>
            2. User enters a keyword in the search bar.<br>
            3. The system filters and displays relevant mentors matching the search term.<br>
            4. If no results are found, the system displays a "No mentors found" message.<br>
            5. User can refine the search by entering a different keyword.<br>
            6. Upon selecting a mentor, the user is redirected to the mentor's profile for more details.
        </td>
    </tr>
    <tr>
        <th>Outcome</th>
        <td>User finds and selects a suitable mentor for guidance.</td>
    </tr>
</table>
      </td>
  </tr>
