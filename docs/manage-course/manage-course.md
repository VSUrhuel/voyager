...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
          ...
          <img src="https://github.com/user-attachments/assets/35350a71-90c0-49aa-8d1f-f36990aec5dd" alt="Alt Text" width="200">
        <h2>Manage Course</h2>  
    ...
    <tr>
        <th>Goal</th>
        <td>Manage different types of courses within the application.</td>
    </tr>
    <tr>
        <th>Preconditions</th>
    ...
    <tr>
        ...
        <td>
            ...
            2. when the "View Courses" button was clicked, admin immediately gains access to all courses management.<br>
            3. Admin can now archive, edit, restore or add courses in the application.<br>
        </td>
    </tr>
    <tr>
        <th>Outcome</th>
        <td>The admin gains access to the management of courses in maintaining<br>the usability and relevance of the courses in the application.</td>
    </tr>
</table>
      </td>
  </tr>
