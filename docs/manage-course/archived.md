...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
          ...
          <img src="https://github.com/user-attachments/assets/a74aa16e-e7d2-421c-b1d7-463dbcc99154" alt="Alt Text" width="200">
    ...
    <tr>
        <th>Use Case</th>
        <th>Archived Courses Display</th>
    </tr>
    <tr>
        <th>Actor(s)</th>
        <td>Admin</td>
    ...
    <tr>
        <th>Goal</th>
        <td>Browse on archived courses for an easy access and restoration.</td>
    </tr>
    <tr>
        <th>Preconditions</th>
        <td>The logged-in user must be have an admin access</td>
    </tr>
    <tr>
        <th>Main Scenario</th>
        <td>
            1. Admin clicks on the "archived" button at the top of the courses.<br>
            2. All archived courses will then be displayed.<br>
        </td>
    </tr>
    <tr>
        <th>Outcome</th>
        <td>The admin can view all deleted courses within the app.</td>
    </tr>
</table>
      </td>
  </tr>
