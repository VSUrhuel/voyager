...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <img src="https://github.com/user-attachments/assets/ee0264b4-6e98-4e65-8681-ce029d0e5a8e"
           alt="Rejected Mentees" width="200">
      <h2>Rejected Mentees</h2>  
      <p>
          The Rejected Mentees section displays a list of mentees whose applications have been rejected. 
          However, mentors can review and reconsider these applications, allowing them to approve a rejected mentee if needed.
      </p>
      <h2>Use Case Scenario</h2> 
      <table border="1">
          <tr>
              <th>Use Case</th>
              <th>Managing Rejected Mentees</th>
          </tr>
          <tr>
              <th>Actor(s)</th>
              <td>Mentor</td>
          ...
          <tr>
              <th>Goal</th>
              <td>Review rejected mentees and decide whether to accept or keep them rejected.</td>
          </tr>
          <tr>
              <th>Preconditions</th>
              <td>The mentor is logged into the app and has at least one rejected mentee.</td>
          </tr>
          <tr>
              <th>Main Scenario</th>
              <td>
                  1. Mentor logs into the platform.<br>
                  2. Mentor navigates to the "Rejected Mentees" section.<br>
                  3. Mentor reviews the list of rejected mentees.<br>
                  4. Mentor can take the following actions:<br>
                     &nbsp;&nbsp;&nbsp;- Approve a mentee if they reconsider their decision.<br>
                     &nbsp;&nbsp;&nbsp;- Keep the rejection if the mentee does not meet requirements.<br>
          ...
          <tr>
              <th>Outcome</th>
              <td>The mentor successfully manages rejected mentees, either approving them or keeping them rejected.</td>
          </tr>
      </table>
      </td>
  </tr>
