...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <img src="https://github.com/VSUrhuel/voyager/blob/main/docs/images/approved-mentee.png?raw=true" 
           alt="Manage Mentee" width="200">  
      <h2>Manage Mentee</h2>  
      <p>
          This section allows mentors to manage their mentees by reviewing requests, accepting or rejecting new mentees, 
          and suspending mentees if necessary. Effective mentee management ensures a well-organized mentoring process.
      </p> 
      <h2>Use Case Scenario</h2> 
      <table border="1">
          <tr>
              <th>Use Case</th>
              <th>Mentor Managing Mentees</th>
          </tr>
          <tr>
              <th>Actor(s)</th>
              <td>Mentor</td>
          ...
          <tr>
              <th>Goal</th>
              <td>Effectively manage mentees by reviewing requests and taking appropriate actions.</td>
          </tr>
          <tr>
              <th>Preconditions</th>
              <td>The mentor is logged into their account and has access to the mentoring dashboard.</td>
          </tr>
          <tr>
              <th>Main Scenario</th>
              <td>
                  1. Mentor logs into the platform.<br>
                  2. Mentor navigates to the "Manage Mentee" section.<br>
                  3. Mentor views pending mentee requests.<br>
                  4. Mentor can take the following actions:<br>
                     &nbsp; &nbsp; &nbsp;- Accept a mentee request.<br>
                     &nbsp; &nbsp; &nbsp;- Reject a mentee request.<br>
                     &nbsp; &nbsp; &nbsp;- Suspend an existing mentee if necessary.<br>
                  5. System updates the mentee list accordingly.<br>
                  6. Mentee receives a notification about the status of their request.<br>
              </td>
          </tr>
          <tr>
              <th>Outcome</th>
              <td>The mentor successfully manages mentees, ensuring an efficient mentoring process.</td>
          </tr>
      </table>
      </td>
  </tr>
