...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
    ...
    <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/manage-mentee/approved.md">Approved Mentees</a><br><br> 
    <img src="https://raw.githubusercontent.com/VSUrhuel/voyager/refs/heads/main/docs/images/approved-mentee.png?token=GHSAT0AAAAAAC26334WUBQO3MLIUX6532CEZ55LEQQ" 
         alt="Approved Mentees" width="200">  
    <h2>Approved Mentees</h2>  
    <p>
        The Approved Mentees section displays a list of mentees who have been accepted by the mentor. 
        Mentors can still manage these mentees by suspending them if necessary.
    </p>
    <h2>Use Case Scenario</h2> 
    <table border="1">
        <tr>
            <th>Use Case</th>
            <th>Managing Approved Mentees</th>
        </tr>
        <tr>
            <th>Actor(s)</th>
            <td>Mentor</td>
        ...
        <tr>
            <th>Goal</th>
            <td>Monitor and manage approved mentees, including the ability to suspend or remove them if necessary.</td>
        </tr>
        <tr>
            <th>Preconditions</th>
            <td>The mentor is logged into the app and has at least one approved mentee.</td>
        </tr>
        <tr>
            <th>Main Scenario</th>
            <td>
                1. Mentor logs into the platform.<br>
                2. Mentor navigates to the "Approved Mentees" section.<br>
                3. Mentor views a list of all currently approved mentees.<br>
                4. Mentor can take the following actions:<br>
                   &nbsp; &nbsp; &nbsp; - Suspend a mentee if they violate guidelines.<br>
                5. System updates the mentee status accordingly.<br>
                6. Mentee receives a notification about their updated status.<br>
            </td>
        </tr>
        <tr>
            <th>Outcome</th>
            <td>The mentor successfully manages approved mentees, ensuring an organized mentoring process.</td>
        </tr>
    </table>
      </td>
  </tr>
