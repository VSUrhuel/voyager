...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
          <a href="#">Homepage</a> &gt; <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/manage-mentors/manage-mentors.md">Manage Mentors</a><br><br>
          <img src="https://raw.githubusercontent.com/VSUrhuel/voyager/refs/heads/main/docs/images/manage-mentor.png?token=GHSAT0AAAAAAC26334XMLOHTBHALCUBDR4EZ55LH2A" alt="Manage Mentors" width="200">
        <h2>Manage Mentors</h2>  
        <p>This page serves as the gateway for the admin in managing all mentors in a course.</p>
        <h2>Use Case Scenario</h2> 
        <table border="1">
    <tr>
        <th>Use Case</th>
        <th>Mentors Management</th>
    </tr>
    <tr>
        <th>Actor(s)</th>
        <td>Admin</td>
    ...
    <tr>
        <th>Goal</th>
        <td>Manage the creation, suspension and archiving of mentors within the application.</td>
    </tr>
    <tr>
        <th>Preconditions</th>
        <td>The user logged in must have an admin access.</td>
    </tr>
    <tr>
        <th>Main Scenario</th>
        <td>
            1. Right after logging in, this page will be the homepage of the admin.<br>
            2. When the "View Mentors" button was clicked, admin immediately gains access to all mentors for management.<br>
            3. Admin can now archive, suspend or add a mentor for a course in the application.<br>
        </td>
    </tr>
    <tr>
        <th>Outcome</th>
        <td>The admin can now decide the roles and allocations of mentors in each courses.</td>
    </tr>
</table>
      </td>
  </tr>
