...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
        ...
        <img src="https://github.com/user-attachments/assets/42b28c0d-13f9-4161-b0ba-516b55ba7949"
             alt="Completed Sessions" width="200">
        <h2>Completed Sessions</h2>  
        <p>
            The Completed Sessions section allows mentors to review past mentoring sessions. 
            Mentors can see session details such as the date and time of the completed session. 
        </p>
        <h2>Use Case Scenario</h2> 
        <table border="1">
            <tr>
                <th>Use Case</th>
                <th>Reviewing Completed Mentoring Sessions</th>
            </tr>
            <tr>
                <th>Actor(s)</th>
                <td>Mentor</td>
            ...
            <tr>
                <th>Goal</th>
                <td>Track past mentoring sessions, review feedback, and maintain records.</td>
            </tr>
            <tr>
                <th>Preconditions</th>
                <td>The mentor is logged into the platform and has completed past mentoring sessions.</td>
            </tr>
            <tr>
                <th>Main Scenario</th>
                <td>
                    1. Mentor logs into the platform.<br>
                    2. Mentor navigates to the "Completed Sessions" section.<br>
                    3. The system displays a list of past sessions, including:<br>
                       &nbsp;   &nbsp;- Date and time of the session.<br>
                       &nbsp;   &nbsp;- Session details such as topics covered and key discussion points.<br>
                </td>
            </tr>
            <tr>
                <th>Outcome</th>
                <td>The mentor successfully reviews and manages their completed mentoring sessions.</td>
            </tr>
        </table>
      </td>
  </tr>
