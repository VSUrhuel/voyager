...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
        ...
        <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/manage-schedule/upcoming.md">Upcoming Schedule</a> <br><br>
        <img src="https://raw.githubusercontent.com/VSUrhuel/voyager/refs/heads/main/docs/images/upcoming-schedule.png?token=GHSAT0AAAAAAC26334X4ZENVYIA4IGNVUOQZ55LKBQ"
             alt="Upcoming Schedule" width="200">
        <h2>Upcoming Schedule</h2>  
        <p>
            The Upcoming Schedule section allows mentors to view their scheduled mentoring sessions. 
            Mentors can see details such as the date, time, and other details ensuring they stay prepared. 
        </p>
        <h2>Use Case Scenario</h2> 
        <table border="1">
            <tr>
                <th>Use Case</th>
                <th>Viewing Upcoming Mentoring Sessions</th>
            </tr>
            <tr>
                <th>Actor(s)</th>
                <td>Mentor</td>
            ...
            <tr>
                <th>Goal</th>
                <td>Stay informed about scheduled mentoring sessions and prepare accordingly.</td>
            </tr>
            <tr>
                <th>Preconditions</th>
                <td>The mentor is logged into the platform and has upcoming scheduled sessions.</td>
            </tr>
            <tr>
                <th>Main Scenario</th>
                <td>
                    1. Mentor logs into the platform.<br>
                    2. Mentor navigates to the "Upcoming Schedule" section under the session section.<br>
                    3. The system displays a list of upcoming sessions, including:<br>
                       &nbsp;   &nbsp;- Date and time of the session.<br>
                       &nbsp;   &nbsp;- Session details such as topics to be covered.<br>
                    4. Mentor can set reminders or notify mentees if necessary.<br>
                    5. Mentor prepares for the session based on the provided details.<br>
                </td>
            </tr>
            <tr>
                <th>Outcome</th>
                <td>The mentor successfully tracks and manages their upcoming mentoring sessions.</td>
            </tr>
        </table>
      </td>
  </tr>
