...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
        ...
        <img src="https://github.com/VSUrhuel/voyager/blob/main/docs/images/manage-schedule.png?raw=true"
             alt="Manage Schedules" width="200">
        <h2>Manage Schedules</h2>  
        <p>
            The Manage Schedules section allows mentors to efficiently handle their mentoring sessions. 
            Mentors can add new schedules, view upcoming and past schedules, and notify mentees about scheduled meetings.
        </p>
        <h2>Use Case Scenario</h2> 
        <table border="1">
            <tr>
                <th>Use Case</th>
                <th>Scheduling and Managing Mentoring Sessions</th>
            </tr>
            <tr>
                <th>Actor(s)</th>
                <td>Mentor</td>
            ...
            <tr>
                <th>Goal</th>
                <td>Effectively schedule, track, and notify mentees about mentoring sessions.</td>
            </tr>
            <tr>
                <th>Preconditions</th>
                <td>The mentor is logged into the app and has access to scheduling features.</td>
            </tr>
            <tr>
                <th>Main Scenario</th>
                <td>
                    1. Mentor logs into the platform.<br>
                    2. Mentor navigates to the "Manage Schedules" section.<br>
                    3. Mentor can perform the following actions:<br>
                       &nbsp;  &nbsp;- Add a new schedule for a mentoring session.<br>
                       &nbsp;  &nbsp;- View upcoming schedules to prepare for future sessions.<br>
                       &nbsp;  &nbsp;- Check past schedules for record-keeping and tracking progress.<br>
                       &nbsp;  &nbsp;- Send notifications automatically to mentees about upcoming sessions.<br>
                    4. Mentees receive notifications and reminders about scheduled meetings.<br>
                </td>
            </tr>
            <tr>
                <th>Outcome</th>
                <td>The mentor successfully manages their schedules, ensuring effective communication and session organization.</td>
            </tr>
        </table>
      </td>
  </tr>
