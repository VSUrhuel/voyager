...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <br><br>   
      <img src="https://github.com/VSUrhuel/voyager/blob/main/docs/images/register.jpg?raw=true" 
           alt="Register" width="200">
      <h2>Register</h2>  
      <p>
          This is the registration feature of account creation, allowing mentees to create an account manually 
          using an email and password or sign up seamlessly via Google authentication.
      </p>     
      ...
      <table border="1">
          ...
          <tr>
              <th>Goal</th>
              <td>Create an account to access the platform.</td>
          </tr>
          <tr>
              <th>Preconditions</th>
              <td>User does not have an existing account and must register.</td>
          </tr>
          <tr>
              <th>Main Scenario</th>
              <td>
                  1. User navigates to the registration page.<br>
                  2. User can do manual registration (default) or Google sign-up.<br>
                  3. If manual registration, user will input needed information for <span><a href="https://github.com/VSUrhuel/voyager/blob/main/docs/account-creation/account-creation.md">account creation</a></span>.<br>
                  4. If Google sign-up is selected, the user authenticates via their Google account.<br>
                  5. System validates the information and creates the account.<br>
              </td>
          </tr>
          <tr>
              <th>Outcome</th>
              <td>The user successfully registers and can log in to access features, once verfiied.</td>
          </tr>
      </table>
      </td>
  </tr>
