...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
          ...
          <img src="https://github.com/VSUrhuel/voyager/blob/main/docs/images/choose-mentor.png?raw=true" alt="Choose Mentor" width="200">
        <h2>Choose Mentor</h2>  
...
<table border="1">
    ...
    <tr>
        <th>Goal</th>
        <td>Find and select a mentor based on availability and expertise</td>
    </tr>
    <tr>
        <th>Preconditions</th>
    ...
    <tr>
        <th>Main Scenario</th>
        <td>
            1. The student opens the "Choose Mentor" page.<br>
            2. The student browses through the available mentors.<br>
            3. The student views mentor details such as schedule and expertise.<br>
            4. The student selects a mentor.
        </td>
    </tr>
    <tr>
        <th>Outcome</th>
