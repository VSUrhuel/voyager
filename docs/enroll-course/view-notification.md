...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
          <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/homepage/homepage.md">Homepage</a> &gt; <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/login-account/login-account.md">Login</a> &gt; <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/enroll-course/view-notification.md">Notification</a><br><br>
          <img src="https://github.com/VSUrhuel/voyager/blob/main/docs/images/view-notification.png?raw=true" alt="View Notification" width="200">
...
<table border="1">
    ...
    <tr>
        <th>Goal</th>
        <td>Stay informed about mentorship sessions, study materials, and other updates</td>
    </tr>
    <tr>
        <th>Preconditions</th>
        <td>User must have a registered mentee account and enrolled in at least one course</td>
    </tr>
    <tr>
        <th>Main Scenario</th>
        <td>
            The user opens the notifications page.<br>
            The user views the most recent notifications under "Today".<br>
            The user checks older notifications under "Previous Notifications".<br>
            The user clicks on a notification to access further details if necessary.<br>
        </td>
    </tr>
    <tr>
        <th>Outcome</th>
        <td>The user stays updated with upcoming mentorship sessions and important academic reminders.</td>
    </tr>
</table>
      </td>
  </tr>
