...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
          ...
          <img src="https://github.com/user-attachments/assets/e2e9b59f-2754-4b7b-9f66-dac295d48342" alt="Alt Text" width="200">
    <h2>Log in</h2>  
    <p>
        The Login feature allows registered users to access their accounts securely. Users can enter their 
        credentials (email and password) or log in via Google authentication.
    </p>
    ...
    <table border="1">
        ...
        <tr>
            <th>Goal</th>
            <td>Access the platform by logging into their account.</td>
        </tr>
        <tr>
            <th>Preconditions</th>
            <td>User must have an existing registered account.</td>
        </tr>
        <tr>
            <th>Main Scenario</th>
            <td>
                1. User navigates to the login page.<br>
                2. User enters their email and password.<br>
                3. If correct, the system grants access to the account.<br>
                4. If incorrect, the system displays an error message and prompts a retry.<br>
                5. User can also choose the <span><a href="https://github.com/VSUrhuel/voyager/blob/main/docs/login-account/login-with-google.md">"Login with Google"</a></span> option for seamless authentication.<br>
                6. If the login is successful, the user is redirected to the dashboard.<br>
            </td>
        </tr>
        <tr>
            <th>Outcome</th>
            <td>User successfully logs in and gains access to platform features.</td>
        </tr>
    </table>
      </td>
  </tr>
