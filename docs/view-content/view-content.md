...
<table border="1" cellpadding="0" cellspacing="0" style="width: 80%; font-size: 10px;"> 
  ...
  <tr>
      ...
      <td valign="top" style="width: 30%;">
          <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/homepage/homepage.md">Homepage</a> &gt; <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/login-account/login-account.md">Login</a> &gt; <a href="https://github.com/VSUrhuel/voyager/blob/main/docs/view-content/view-content.md">Contents</a><br><br>
          <img src="https://github.com/VSUrhuel/voyager/blob/main/docs/images/view-content.png?raw=true" alt="View Content" width="200">
...
<table border="1">
    ...
    <tr>
        <th>Goal</th>
        <td>Allow students to access and review course-related content, including announcements, materials, and study resources.</td>
    </tr>
    <tr>
        <th>Preconditions</th>
        <td>The user must be enrolled in a course and have access to the learning platform.</td>
    </tr>
    <tr>
        <th>Main Scenario</th>
        <td>
            1. User navigates to the View Content page.<br>
            2. The system displays recent course-related content." <br>
            3. Mentee can read and follow instruction posted by the mentor" <br>
            4. If there are no new updates, a "No more content" message is displayed.<br>
        </td>
    </tr>
    <tr>
        <th>Outcome</th>
